...
export const ITEMS: Record<ItemId, ItemDef> = {
  ...
  TORCH:         { id:'TORCH',         displayName:'Torch', description:'Placeable marker. It gives off no light yet.',         tags:['PLACEABLE'], stackable:true,  maxStack:32, placesEntity:'TORCH',    iconIndex:9 },
  LANTERN:       { id:'LANTERN',       displayName:'Lantern', description:'Placeable marker. It gives off no light yet.',       tags:['PLACEABLE'], stackable:true,  maxStack:16, placesEntity:'LANTERN',  iconIndex:10 },
  ...
  CHEST:         { id:'CHEST',         displayName:'Chest', description:'Placeable, but storage is not wired up yet.',         tags:['PLACEABLE'], stackable:false, maxStack:1,  placesEntity:'CHEST',    iconIndex:12 },
  ...
  WOOD_SWORD:    { id:'WOOD_SWORD',    displayName:'Wood Sword', description:'Double the damage of bare fists.',    tags:['WEAPON'],    stackable:false, maxStack:1,  damage:1.0, iconIndex:15 },
  WOOD_AXE:      { id:'WOOD_AXE',      displayName:'Wood Axe', description:'Required to fell trees. Bare hands leave them standing.',      tags:['TOOL_AXE'],  stackable:false, maxStack:1,  damage:0.5, miningPower:1, iconIndex:16 },
  WOOD_PICKAXE:  { id:'WOOD_PICKAXE',  displayName:'Wood Pickaxe', description:'Required to mine rock, coal and iron ore.',  tags:['TOOL_PICK'], stackable:false, maxStack:1,  damage:0.5, miningPower:1, iconIndex:17 },
  ...
  IRON_AXE:      { id:'IRON_AXE',      displayName:'Iron Axe', description:'Fells a tree in half the swings of a wood axe.',      tags:['TOOL_AXE'],  stackable:false, maxStack:1,  damage:1.0, miningPower:2, iconIndex:19 },
  IRON_PICKAXE:  { id:'IRON_PICKAXE',  displayName:'Iron Pickaxe', description:'Mines the same tiles as a wood pickaxe, at double the damage.',  tags:['TOOL_PICK'], stackable:false, maxStack:1,  damage:1.0, miningPower:2, iconIndex:20 },
  IRON_SHOVEL:   { id:'IRON_SHOVEL',   displayName:'Iron Shovel', description:'No recipe, and digging is not in the game yet.',   tags:['TOOL_SHOVEL'],stackable:false, maxStack:1,  damage:0.5, miningPower:2, iconIndex:21 },
  IRON_HOE:      { id:'IRON_HOE',      displayName:'Iron Hoe', description:'No recipe, and farming is not in the game yet.',      tags:['TOOL_HOE'],  stackable:false, maxStack:1,  damage:0.5, iconIndex:22 },

  APPLE:         { id:'APPLE',         displayName:'Apple', description:'Restores a little energy. Nothing in the world drops it yet.',         tags:['FOOD'],      stackable:true,  maxStack:16, iconIndex:23, healEnergy:2, healHealth:0.5 },
  ...
  SEEDS:         { id:'SEEDS',         displayName:'Seeds', description:'There is no farming yet, so nothing grows from these.',         tags:['RESOURCE'],  stackable:true,  maxStack:32, iconIndex:29 },
  WHEAT:         { id:'WHEAT',         displayName:'Wheat', description:'Three make two bread. Only a world event grants it.',         tags:['RESOURCE'],  stackable:true,  maxStack:32, iconIndex:30 },
  ...
  BED:           { id:'BED',           displayName:'Bed', description:'Place it and press K to sleep through to dawn.',           tags:['PLACEABLE'], stackable:false, maxStack:1,  placesEntity:'BED', iconIndex:32 },
